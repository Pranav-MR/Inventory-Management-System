  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          'bg-popover data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 fixed top-[50%] left-[50%] z-50 grid w-full max-w-[calc(100%-2rem)] translate-x-[-50%] translate-y-[-50%] gap-4 rounded-2xl border p-7 shadow-[0_24px_70px_rgba(0,0,0,0.4)] backdrop-blur-2xl duration-200 sm:max-w-lg dark:shadow-[0_24px_70px_rgba(0,0,0,0.6),0_0_40px_rgba(34,211,238,0.15)]',
          className,
        )}
        {...props}
      >
